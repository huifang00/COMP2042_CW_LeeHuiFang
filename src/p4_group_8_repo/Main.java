...
public class Main extends Application {
    ...
    public void addLog(MyStage background) {
    	...
    	l1 = new Log("file:src/p4_group_8_repo/log3.png", 0, 166, 0.75, 150, 150);
    	background.add(l1);
    	l2 = new Log("file:src/p4_group_8_repo/log3.png", 220, 166, 0.75, 150, 150);
    	background.add(l2);
    	l3 = new Log("file:src/p4_group_8_repo/log3.png", 440, 166, 0.75, 150, 150);
    	background.add(l3);
    	l4 = new Log("file:src/p4_group_8_repo/logs.png", 0, 276, -2, 300, 300);
    	background.add(l4);
    	l5 = new Log("file:src/p4_group_8_repo/logs.png", 400, 276, -2, 300, 300);
    	background.add(l5);
    	l6 = new Log("file:src/p4_group_8_repo/log3.png", 50, 329, 0.75, 150, 150);
    	background.add(l6);
    	l7 = new Log("file:src/p4_group_8_repo/log3.png", 270, 329, 0.75, 150, 150);
    	background.add(l7);
    	l8 = new Log("file:src/p4_group_8_repo/log3.png", 490, 329, 0.75, 150, 150);
    	background.add(l8);
    ...
    public void addTurtle(MyStage background) {
		...
		*/
    	...
    	weturtle1 = new WetTurtle("file:src/p4_group_8_repo/TurtleAnimation2Wet.png", 700, 376, -1, 130, 130);
    	background.add(weturtle1);
    	weturtle2 = new WetTurtle("file:src/p4_group_8_repo/TurtleAnimation2Wet.png", 600, 217, -1, 130, 130);
