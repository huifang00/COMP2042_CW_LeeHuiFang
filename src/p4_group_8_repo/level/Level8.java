...
public class Level8 implements Level{
    ...
    */
    ...
    /**
     * This is the method to set the score which player get for level 8.
     * @param score The score which player get for level 8.
     * @since 1.8
     */
    ...
    /**
     * This is the method to get the score of level 8 which player achieved.
     * @return int This returns the score of level 8 which player achieved.
     * @since 1.8
     */
    public int getScore() {
    	return score;
