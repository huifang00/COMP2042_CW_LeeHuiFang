...
public class Level9 implements Level{
    ...
    */
    ...
    /**
     * This is the method to set the score which player get for level 9.
     * @param score The score which player get for level 9.
     * @since 1.8
     */
    ...
    /**
     * This is the method to get the score of level 9 which player achieved.
     * @return int This returns the score of level 9 which player achieved.
     * @since 1.8
     */
    public int getScore() {
    	return score;
